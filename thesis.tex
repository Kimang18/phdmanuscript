...
% === META DATA ===============================================================
\title{Reinforcement Learning in Structured Dynamic System}
\author{Kimang KHUN}
...
\bookmarksetup{startatroot}
\inputchapter{\includechaptermultiarmedbandit}{chapter_multiarmedbandit.tex}

\bookmarksetup{startatroot}
\inputchapter{\includechapterfinitehorizon}{chapter_finitehorizon.tex}
