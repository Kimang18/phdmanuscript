...
\begin{thm}[Multichain restless bandit]
    ...
    \begin{enumerate}[label=(\roman*)]
        \item \label{thm:not_ergodic} there exists a restless bandit, whose arms all are recurrent, that is not weakly communicating % the term noncommunicating is taken from [Puterman, 1994, page 353]. 
