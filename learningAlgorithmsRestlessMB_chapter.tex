...
REGAL       & $\tilde{O}(sp(\vh^*)S\sqrt{AT})$ \cite{bartlett2012regal} & weakly communicating & No efficient implementation   \\ 
...
EBF         & $\tilde{O}(\sqrt{sp(\vh^*)SAT})$ \cite{zhang2019regret} & weakly communicating     & No efficient implementation   \\ \hline
