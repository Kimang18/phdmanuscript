...
In Bayesian perspective, we say that the unknown MDP $M$ is drawn according to a probability distribution (prior or posterior) $\phi$. % to mean that $r$ is drawn from a dedicated probability distribution (prior or posterior) and $p$ is drawn from another dedicated probability distribution (prior or posterior).
...
The quest to minimax regret lower bound for the infinite horizon setting is longer compared to the finite horizon setting.
