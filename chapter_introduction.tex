...
\node (idx) [rect, below = 1.25cm of mb, label={[font=\small\sffamily,name=part2]above left:{Part II: Indexability}}] {Chapter 5: Indexability};
\node (widx) [rect, below = 0.75cm of idx] {Chapter 6: Index Computation};

\node (rested) [rect, below = 3cm of rl, label={[font=\small\sffamily,name=part3]above right:{Part III: Learning}}] {Chapter 7: Learning Rested Bandit};
