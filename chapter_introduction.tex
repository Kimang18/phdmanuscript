...
In Chapter~\ref{ch:learning_restless}, we consider the RL problems in which the unknown environment is restless Markovian bandit with average reward criterion.
